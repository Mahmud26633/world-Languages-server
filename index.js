...
async function run() {
  try {
    ...
    const db = client.db("worldLanguagesDB").collection("db");
    const paymentCollection = client
      .db("worldLanguagesDB")
      .collection("payments");
    const classes = client.db("worldLanguagesDB").collection("classes");
    const cart = client.db("worldLanguagesDB").collection("cart");
    const users = client.db("worldLanguagesDB").collection("users");
